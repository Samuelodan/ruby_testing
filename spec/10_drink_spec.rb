...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:my_juice) { described_class.new('5alive') }

      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(my_juice.type).to eq('5alive')
      end

      # remove the 'x' before running this test
      it 'has 16 ounces' do
        expect(my_juice.ounces).to be(16)
      end
    end
  end
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      # Create an explicit subject, using 'described_class' and your choice of
      # beverage type.
      subject(:my_drink) { described_class.new('chivita', 18) }
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_drink) { described_class.new('Pulpy', 10) }
      # remove the 'x' before running this test
      it 'is not full' do
